    ...
    <div className="max-w-4xl mx-auto bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-xl border border-mcd-purple/30 shadow-2xl overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-mcd-purple/20 to-mcd-gold/20 px-6 py-4 border-b border-mcd-purple/30">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-lg bg-gradient-to-r from-mcd-purple via-mcd-gold to-mcd-purple bg-clip-text text-transparent">
      ...
      <div className="p-6 space-y-6">
        {LEVEL_ORDER.map(level => (
          <div 
            key={level} 
            className={`bg-gradient-to-br ${LEVEL_COLORS[level]} rounded-xl border p-4`}
          >
...
function RankCard({ rank, isSelected, onSelect, healthPoints, divisionAccess, canRKAuthority }: RankCardProps) {
  ...
  return (
    <div 
      className={`text-left rounded-lg border transition-all duration-300 group ${
        isSelected
    ...
    >
      ...
      >
        ...
        {/* Owner Badge */}
        {rank.owner && (
          <div className="text-xs text-green-300 bg-green-900/30 border border-green-500/30 rounded px-2 py-1 mb-2 truncate">
        ...
        {/* Requirements Badge */}
        {rank.requirements && (
          <div className="text-xs text-blue-300 bg-blue-900/30 border border-blue-500/30 rounded px-2 py-1 truncate">
      ...
      {isSelected && (
        ...
        >
          <div className="pt-3 border-t border-gray-600/30 space-y-2">
            <DetailRow label="Health Points" value={healthPoints} />
            <DetailRow label="Division Access" value={divisionAccess} />
            <DetailRow label="CanRK Authority" value={canRKAuthority} />
          </div>
        </div>
      )}
    </div>
